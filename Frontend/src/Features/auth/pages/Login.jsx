...
export const Login = () => {
  ...
  const { handleLogin, handleGoogleLogin } = useAuth(); // Assuming your hook handles Google too
  ...
  const onGoogleSignIn = async () => {
    ...
    try {
        // Implement logic for Firebase or Auth0 Google redirect/popup here
  ...
  return (
    <section className="relative min-h-screen bg-[#050505] text-white py-20 px-6 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          {/* Subtle Outer Glow */}
          <div className="absolute -inset-0.5 bg-gradient-to-r from-accent/20 to-purple-500/20 rounded-[2.5rem] blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.div variants={itemVariants} className="space-y-2">
                <div className="flex justify-between items-center px-1">
                    ...
                    <Link to="/forgot-password" size={18} className="text-xs text-accent hover:underline">
                        Forgot?
                    </Link>
                </div>
                <div className="relative group/input">
