          ...
          {!isSubmitted ? (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  <User
                    className="absolute left-0 top-3 text-accent"
                    size={18}
                  />
              ...
              <div className="pt-2">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full bg-bg2/50 border border-border rounded-xl px-4 py-3 focus:outline-none focus:border-accent transition-all text-text appearance-none cursor-pointer"
                  >
                    <option
                      value=""
                      className="bg-bg2"
                    ...
                    <option
                      value="Full Stack Development Bootcamp"
                      className="bg-bg2"
                    >
                    ...
                    <option
                      value="Data Science Masterclass"
                      className="bg-bg2"
                    >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full group mt-4 bg-accent hover:bg-accent/90 text-bg py-4 rounded-xl font-bold uppercase tracking-widest flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-lg shadow-accent/10 disabled:opacity-70"
              >
                {loading ? (
                  <>
                    <Loader2
            ...
            >
              ...
              <p className="text-text-secondary">
                We've noted your preferred time.
